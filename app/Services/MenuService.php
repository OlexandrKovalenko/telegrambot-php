...
class MenuService
{
    ...
    {
        $this->data['msgId'] && $this->data['inlineMsg'] ?  $this->generateAnswerInlineMenu($this->menuArr,$this->data['inlineMsg']) : null;
        $this->data['botMessage'] && !$this->data['msgId'] ? $this->generateButtonMenu($this->data['userSite'], $this->data['botMessage']) : null;
        $this->data['inlineMsg'] && !$this->data['msgId'] ? $this->generateInlineMenu($this->menuArr, $this->data['inlineMsg']) : null;
